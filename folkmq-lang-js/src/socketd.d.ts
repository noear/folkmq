...
declare module "transport/core/Constants" {
    import { ByteBuffer } from "transport/core/Buffer";
    /**
     * 常量
     *
     * @author noear
...
declare module "transport/core/Message" {
    import type { Entity, Reply } from "transport/core/Entity";
    import type { CodecReader } from "transport/core/Codec";
    import type { Buffer } from "transport/core/Buffer";
    /**
     * 消息
     *
     * @author noear
...
declare module "transport/core/Frame" {
    import { Message, MessageInternal } from "transport/core/Message";
    /**
     * 帧（帧[消息[实体]]）
     *
     * @author noear
...
declare module "transport/core/Codec" {
    import type { Frame } from "transport/core/Frame";
    import type { IoFunction } from "transport/core/Typealias";
    /**
     * 编解码缓冲读
     *
     * @author noear
...
declare module "exception/SocketdException" {
...
declare module "transport/core/Entity" {
    import { CodecReader } from "transport/core/Codec";
    import { type Buffer } from "transport/core/Buffer";
    /**
     * 消息实体（帧[消息[实体]]）
     *
...
declare module "transport/core/Asserts" {
    import type { Channel } from "transport/core/Channel";
    /**
     * 断言
     *
     * @author noear
...
declare module "transport/core/Stream" {
    import type { Reply } from "transport/core/Entity";
    import type { MessageInternal } from "transport/core/Message";
    import type { Channel } from "transport/core/Channel";
    import type { IoConsumer } from "transport/core/Typealias";
...
declare module "transport/core/IdGenerator" {
...
declare module "transport/core/FragmentHolder" {
    import type { MessageInternal } from "transport/core/Message";
...
declare module "transport/core/FragmentAggregator" {
    import { MessageInternal } from "transport/core/Message";
    import { Frame } from "transport/core/Frame";
    /**
     * 分片聚合器
     *
     * @author noear
...
declare module "transport/core/FragmentHandler" {
    import type { Channel } from "transport/core/Channel";
    import type { Frame } from "transport/core/Frame";
    import type { MessageInternal } from "transport/core/Message";
    ...
    export interface FragmentHandler {
         ...
         * @param consumer 分片消费
         */
        spliFragment(channel: Channel, message: MessageInternal, consumer: IoConsumer<Entity>): any;
        /**
         * 聚合分片
         *
         * @param channel       通道
    ...
    export class FragmentHandlerDefault implements FragmentHandler {
         ...
         * @param consumer 分片消费
         */
        spliFragment(channel: Channel, message: MessageInternal, consumer: IoConsumer<Entity>): void;
        spliFragmentDo(fragmentIndex: number, channel: Channel, message: MessageInternal, consumer: IoConsumer<Entity>): void;
        /**
         * 聚合分片
         *
         * @param channel       通道
...
declare module "transport/core/CodecByteBuffer" {
    import type { Config } from "transport/core/Config";
    import { Frame } from "transport/core/Frame";
    import type { IoFunction } from "transport/core/Typealias";
    import type { Codec, CodecReader, CodecWriter } from "transport/core/Codec";
    /**
...
declare module "transport/core/Config" {
    import type { Codec } from "transport/core/Codec";
    import type { StreamManger } from "transport/core/Stream";
    import { IdGenerator } from "transport/core/IdGenerator";
    import { FragmentHandler } from "transport/core/FragmentHandler";
    /**
     * 配置接口
     *
     * @author noear
...
declare module "transport/core/Handshake" {
    import type { MessageInternal } from "transport/core/Message";
    /**
     * 握手信息
     *
...
declare module "transport/core/Channel" {
    import type { Session } from "transport/core/Session";
    import type { Config } from "transport/core/Config";
    import type { HandshakeInternal } from "transport/core/Handshake";
    import type { Message } from "transport/core/Message";
    import type { Frame } from "transport/core/Frame";
    import type { StreamInternal } from "transport/core/Stream";
...
declare module "transport/client/ClientSession" {
    import type { IoConsumer } from "transport/core/Typealias";
...
declare module "transport/core/Session" {
    import type { Entity, Reply } from "transport/core/Entity";
    import type { Message } from "transport/core/Message";
    import type { IoConsumer } from "transport/core/Typealias";
    import type { Channel } from "transport/core/Channel";
    ...
    import type { Handshake } from "transport/core/Handshake";
    /**
     * 会话
     *
     * @author noear
...
declare module "transport/core/RouteSelector" {
    /**
     * 路径映射器
     *
     * @author noear
...
declare module "transport/core/Listener" {
    import type { Session } from "transport/core/Session";
    import type { Message } from "transport/core/Message";
    import type { IoBiConsumer, IoConsumer } from "transport/core/Typealias";
    import { RouteSelector } from "transport/core/RouteSelector";
    /**
     * 监听器
     *
     * @author noear
...
declare module "transport/client/ClientConfig" {
    import { ConfigBase } from "transport/core/Config";
...
declare module "transport/core/HandshakeDefault" {
    import type { HandshakeInternal } from "transport/core/Handshake";
    import type { MessageInternal } from "transport/core/Message";
...
declare module "transport/core/Processor" {
    ...
    export class ProcessorDefault implements Processor {
        ...
        onReceive(channel: ChannelInternal, frame: Frame): void;
        onReceiveDo(channel: ChannelInternal, frame: Frame, isReply: any): void;
...
declare module "transport/core/ChannelAssistant" {
    import type { Frame } from "transport/core/Frame";
    /**
     * 通道助理
     *
...
declare module "transport/client/ClientConnector" {
    import type { IoConsumer } from "transport/core/Typealias";
    import type { Session } from "transport/core/Session";
    import type { ChannelInternal } from "transport/core/Channel";
    import type { ClientInternal } from "transport/client/Client";
    /**
     * 客户端连接器
     *
     * @author noear
...
declare module "transport/core/HeartbeatHandler" {
    import type { Session } from "transport/core/Session";
    import type { IoConsumer } from "transport/core/Typealias";
...
declare module "utils/RunUtils" {
    export class RunUtils {
        static runAndTry(fun: any): void;
    }
}
declare module "transport/client/ClientChannel" {
    import { Channel, ChannelBase } from "transport/core/Channel";
    import type { Frame } from "transport/core/Frame";
    import type { Session } from "transport/core/Session";
    import type { StreamInternal } from "transport/core/Stream";
...
declare module "transport/core/SessionDefault" {
    import { SessionBase } from "transport/core/Session";
    import type { Channel } from "transport/core/Channel";
    import type { Handshake } from "transport/core/Handshake";
    import type { Entity, Reply } from "transport/core/Entity";
...
declare module "transport/client/ClientProvider" {
...
declare module "cluster/ClusterClientSession" {
    import type { ClientSession } from "transport/client/ClientSession";
    import type { Entity, Reply } from "transport/core/Entity";
    import type { Stream } from "transport/core/Stream";
    import type { IoConsumer } from "transport/core/Typealias";
...
declare module "cluster/ClusterClient" {
    import type { Client } from "transport/client/Client";
    import type { ClientConfig } from "transport/client/ClientConfig";
    import type { ClientSession } from "transport/client/ClientSession";
    import type { Listener } from "transport/core/Listener";
...
declare module "transport_websocket/WsChannelAssistant" {
    import type { ChannelAssistant } from "transport/core/ChannelAssistant";
    import type { Frame } from "transport/core/Frame";
    import type { Config } from "transport/core/Config";
...
declare module "transport/client/ClientHandshakeResult" {
    import type { ChannelInternal } from "transport/core/Channel";
    /**
     * 客户端握手结果
     *
...
declare module "transport/core/ChannelSupporter" {
    import type { Processor } from "transport/core/Processor";
    import type { Config } from "transport/core/Config";
    import type { ChannelAssistant } from "transport/core/ChannelAssistant";
    /**
     * 通道支持者（创建通道的参数）
...
declare module "transport/core/ChannelDefault" {
    import type { StreamInternal } from "transport/core/Stream";
    import type { Session } from "transport/core/Session";
    import type { ChannelSupporter } from "transport/core/ChannelSupporter";
    import type { Config } from "transport/core/Config";
    import { Frame } from "transport/core/Frame";
    import { ChannelBase, ChannelInternal } from "transport/core/Channel";
    import type { IoBiConsumer } from "transport/core/Typealias";
...
declare module "transport_websocket/impl/WebSocketClientImpl" {
    import type { WsClient } from "transport_websocket/WsClient";
    import type { IoConsumer } from "transport/core/Typealias";
...
declare module "transport_websocket/WsClientConnector" {
    import { ClientConnectorBase } from "transport/client/ClientConnector";
    import type { ChannelInternal } from "transport/core/Channel";
    import type { WsClient } from "transport_websocket/WsClient";
    import { WebSocketClientImpl } from "transport_websocket/impl/WebSocketClientImpl";
...
declare module "transport_websocket/WsClient" {
    import { ClientBase } from "transport/client/Client";
    import type { ClientConfig } from "transport/client/ClientConfig";
    import { WsChannelAssistant } from "transport_websocket/WsChannelAssistant";
    import type { ClientConnector } from "transport/client/ClientConnector";
    import type { ChannelSupporter } from "transport/core/ChannelSupporter";
...
declare module "transport_websocket/WsClientProvider" {
    import type { Client } from "transport/client/Client";
    import type { ClientConfig } from "transport/client/ClientConfig";
...
declare module "socketd" {
    import type { Client } from "transport/client/Client";
    import { ClusterClient } from "cluster/ClusterClient";
    import { EntityDefault } from "transport/core/Entity";
