 ...
 * @since 1.0
 */
public class TestCase35_batch_subscribe_namespace extends BaseTestCase {
    public TestCase35_batch_subscribe_namespace(int port) {
        super(port);
    }
    ...
    public void start() throws Exception {
        ...
        MqQueue topicConsumerQueue = serverInternal.getQueue("DEFAULT:demo#a");
